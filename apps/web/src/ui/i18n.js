...
const resources = {
  "pt-BR": {
    translation: {
      ...
      safety: "Aviso: acordos, valores e cuidados devem ser combinados entre os tutores. O PetCrushes não se responsabiliza por negociações.",
  ...
  "en": {
    translation: {
      ...
      safety: "Notice: agreements, fees and care are between guardians. PetCrushes is not responsible for negotiations.",
